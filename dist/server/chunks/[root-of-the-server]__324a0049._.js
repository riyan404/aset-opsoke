...
async function GET(request) {
    try {
        ...
        const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token);
        if (!decoded) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid token'
            }, {
        ...
        const user = decoded;
        // Get basic counts
        const [totalAssets, activeAssets, totalDocuments, activeDocuments, totalDigitalAssets, activeDigitalAssets, totalUsers, activeUsers, recentAuditActivities] = await Promise.all([
            ...
            user.role === 'ADMIN' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.count() : 0,
            user.role === 'ADMIN' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.count({
                where: {
                    isActive: true
                }
            }) : 0,
            user.role === 'ADMIN' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].auditLog.count({
                where: {
                    timestamp: {
        ...
        const assetsByCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].asset.groupBy({
            by: [
                'category'
            ],
            _count: {
        ...
        const documentsOverTime = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findMany({
            where: {
                createdAt: {
                    gte: sixMonthsAgo
                },
        ...
        const documentsTimeData = Array.from({
            length: 6
        }, (_, i)=>{
            const date = new Date();
        ...
        let recentAuditActivitiesData = [];
        if (user.role === 'ADMIN') {
            const auditLogs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].auditLog.findMany({
                where: {
                    timestamp: {
        ...
        const digitalAssetsByAspectRatio = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].digitalAsset.groupBy({
            by: [
                'aspectRatio'
            ],
            _count: {
        ...
        const digitalAssetsAspectRatioData = digitalAssetsByAspectRatio.map((item)=>({
                ...
                color: aspectRatioColors[item.aspectRatio] || '#6B7280'
            }));
        const stats = {
            totalAssets,
            activeAssets,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__324a0049._.js.map